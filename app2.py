        ...
        if not records:
            ...
            for record in records:
                ...
                <div class="service-card">
                    ...
                    <div class="service-title">{title}{verification_badge}</div>
                </div>
                <div class="service-card">
    ...
    <div class="verification-steps">
        ...
        <div class="step-item">
            ...
            <div class="step-content">
                ...
                <div class="step-description">Complete the ₦2,500 verification fee via bank transfer or mobile money</div>
            </div>
        </div>
        <div class="step-item">

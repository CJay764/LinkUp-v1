...
st.markdown("""
<script>
window.sendAnnouncementNotification = function(title, body, date) {
    if (!("Notification" in window)) {
        alert("This browser does not support desktop notification");
        return;
    }
    if (Notification.permission === "granted") {
        new Notification(title, { body: body + "\\n" + date, icon: "https://cdn-icons-png.flaticon.com/512/190/190411.png" });
...
def view_talent_profile():
    ...
    # Find the profile image from the users table based on name
    profile_image_url = ""
    ...
    st.markdown(
        ...
        ">
            <div style="
                ...
                justify-content: center;
            ">
                {f'<a href="{profile_image_url}" target="_blank" title="Click to expand"><img src="{profile_image_url}" alt="Profile" style="width:80px;height:80px;border-radius:50%;object-fit:cover;border:2px solid #764ba2;cursor:pointer;"></a>' if profile_image_url else '<div style="width:80px;height:80px;background:rgba(255,255,255,0.2);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:2rem;backdrop-filter:blur(10px);">👤</div>'}
            </div>
            <h1 style="margin: 0; font-size: 2.5rem; font-weight: 700;">{name}{verification_badge}</h1>
...
def show_verification_page():
    ...
    <div class="verification-header">
        <h1>✅ Get Verified</h1>
        <p>Stand out from the crowd and build trust with clients</p>
    </div>
    """, unsafe_allow_html=True)
    
    # If already verified, show different content
    if is_verified:
        st.markdown("""
        <div class="already-verified">
            <h2>🎉 Congratulations!</h2>
            <p>Your account is already verified. You now enjoy all the premium benefits of a verified business account.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col1:
        ...
        <div class="benefit-card">
            ...
            <div class="benefit-title">Build Trust & Credibility</div>
            <div class="benefit-description">
                Display a verified badge that shows clients you're a legitimate business, 
                increasing your chances of getting hired by up to 70%.
            </div>
        </div>
        """, unsafe_allow_html=True)
        ...
        <div class="benefit-card">
            ...
            <div class="benefit-title">Boost Your Visibility</div>
            <div class="benefit-description">
                Verified accounts appear and get featured 
                in our "Verified Professionals" section.
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div class="benefit-card">
            <span class="benefit-icon">⭐</span>
            <div class="benefit-title">Verified Profile Features</div>
            <div class="benefit-description">
                Access advanced profile customization, priority support, 
                and detailed analytics about your service performance.
            </div>
        </div>
        """, unsafe_allow_html=True)
        ...
        <div class="benefit-card">
            <span class="benefit-icon">💼</span>
            <div class="benefit-title">Professional Recognition</div>
            <div class="benefit-description">
                Join our exclusive network of verified professionals and 
                get access to premium client opportunities.
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div class="price-info">
        <div class="price-amount">₦5,950</div>
        <div class="price-period">Yearly verification fee</div>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class="verification-steps">
        <div class="step-item">
            ...
            <div class="step-content">
                <div class="step-title">Click "Get Verified Now"</div>
                <div class="step-description">This will open WhatsApp with a pre-filled message</div>
            </div>
        </div>
        <div class="step-item">
            <div class="step-number">2</div>
            <div class="step-content">
                <div class="step-title">Send the Message</div>
                <div class="step-description">Send the verification request via WhatsApp</div>
            </div>
        </div>
        <div class="step-item">
            ...
            <div class="step-content">
                ...
                <div class="step-description">Complete the ₦5,950 verification fee via bank transfer or mobile money</div>
            </div>
        </div>
        <div class="step-item">
            ...
            <div class="step-content">
                ...
                <div class="step-description">My team would come to you to make sure your business is legal</div>                
                <div class="step-description">Your account will be verified within 24 hours of payment confirmation</div>
            </div>
        </div>
        <div class="step-item">
            <div class="step-number">5</div>
            <div class="step-content">
                <div class="step-title">When Verified</div>
                <div class="step-description">If your business is legal you would be verfied</div>
                <div class="step-description">You would see a blue check-mark on your service</div>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class="verification-cta">
        ...
        <p>Join thousands of verified professionals and take your business to the next level!</p>
    </div>
    """, unsafe_allow_html=True)
    
    # Generate WhatsApp link
    def generate_whatsapp_link(user_name):
        phone_number = "2349130622391"  # Replace with your actual WhatsApp number
...
Thank you! 🙏"""
    ...
    with st.expander("What happens after I make payment?"):
        st.write("""
    ...
    with st.expander("Is the verification permanent?"):
        st.write("Yes for one year! Once verified, your account remains verified for one full year. This is a yearly fee.")
    ...
    with st.expander("Can I get a refund if I'm not satisfied?"):
        st.write("""
        Verification is a service that's completed upon account approval. 
        However, if there are any technical issues with the verification process, 
        we'll work to resolve them or provide appropriate compensation.
        """)
    st.session_state.page= None
